...
public class lab13Test 
{
	...
	public void setUp() throws Exception 
	{
		...
		try
		{
			...
			expectedResult1=testData.get(0).toArray(Integer[]::new);
			...
			expectedResult2=testData.get(1).toArray(Integer[]::new);
			...
			expectedResult3=testData.get(2).toArray(Integer[]::new);
